...
namespace ControllerWrapper
{
    class MacroBank
    {
        ...
        public static List<Macro> Macros = new List<Macro>() {
            ...
            new Macro() { Name = "ps2-dash", Inputs = new List<TPPInput>() { new TPPInput() { Lup = true, Rdown = true, Held_Frames = 4, Sleep_Frames = 4 }, new TPPInput(){ Rup = true, Ldown = true, Held_Frames = 4, Sleep_Frames = 4 }, new TPPInput() { Lup = true, Rdown = true, Held_Frames = 4, Sleep_Frames = 4 }, new TPPInput() { Rup = true, Ldown = true, Held_Frames = 4, Sleep_Frames = 4 }, new TPPInput() { Lup = true, Rdown = true, Held_Frames = 4, Sleep_Frames = 4 }, new TPPInput() { Rup = true, Ldown = true, Held_Frames = 4, Sleep_Frames = 4 }, new TPPInput() { Lup = true, Rdown = true, Held_Frames = 4, Sleep_Frames = 4 }, new TPPInput() { Rup = true, Ldown = true, Held_Frames = 4, Sleep_Frames = 4 }, new TPPInput() { Lup = true, Rdown = true, Held_Frames = 4, Sleep_Frames = 4 }, new TPPInput() { Rup = true, Ldown = true, Held_Frames = 4, Sleep_Frames = 4 } } },
            ...
            new Macro() { Name = "x360-dash", Inputs = new List<TPPInput>() { new TPPInput() { Lup = true, Rdown = true, Held_Frames = 4, Sleep_Frames = 4 }, new TPPInput(){ Rup = true, Ldown = true, Held_Frames = 4, Sleep_Frames = 4 }, new TPPInput() { Lup = true, Rdown = true, Held_Frames = 4, Sleep_Frames = 4 }, new TPPInput() { Rup = true, Ldown = true, Held_Frames = 4, Sleep_Frames = 4 }, new TPPInput() { Lup = true, Rdown = true, Held_Frames = 4, Sleep_Frames = 4 }, new TPPInput() { Rup = true, Ldown = true, Held_Frames = 4, Sleep_Frames = 4 }, new TPPInput() { Lup = true, Rdown = true, Held_Frames = 4, Sleep_Frames = 4 }, new TPPInput() { Rup = true, Ldown = true, Held_Frames = 4, Sleep_Frames = 4 }, new TPPInput() { Lup = true, Rdown = true, Held_Frames = 4, Sleep_Frames = 4 }, new TPPInput() { Rup = true, Ldown = true, Held_Frames = 4, Sleep_Frames = 4 } } },
